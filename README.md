...
## Running
1. Acquire the `.env` file from a maintainer of this project. This is important as it contains the
credentials needed to connect to Firebase. Place this at the root of this repository.
2. Run `expo start` from the root directory of this repository.
